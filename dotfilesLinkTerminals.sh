...
if [ ! -e ~/dotfiles/.config/alacritty_unix ]; then ln -s ~/dotfiles/.config/alacritty_unix/alacritty.toml ~/dotfiles/.config/alacritty/alacritty-unix.toml ; else echo dotfiles/.config/alacritty/alacritty-unix.toml is exist; fi
